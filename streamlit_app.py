...
txt5('R', 'College-Major-Recommender', "Many high school students run into a dilemma upon graduation.They don't know where to begin when trying to select a college major or even had changed their major more than twice afterwards. The tool is to aid in this decision making process.',
